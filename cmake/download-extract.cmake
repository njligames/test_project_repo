...
function(RETRIEVE_LIBRARY DOWNLOAD_DIR DOWNLOAD_URL_PREFIX LIBRARY EXPECTED_SHA256)
  IF(NOT EXISTS ${DOWNLOAD_DIR}/include/${LIBRARY})
    DOWNLOAD_EXTRACT_TAR(
      ${DOWNLOAD_DIR}/include
      ${DOWNLOAD_URL_PREFIX}/include/${LIBRARY}.tar.gz
      ${DOWNLOAD_DIR}/include
      "SKIP"
      ${LIBRARY}
      )
  ENDIF(NOT EXISTS ${DOWNLOAD_DIR}/include/${LIBRARY})

  IF(NOT EXISTS ${DOWNLOAD_DIR}/lib/${LIBRARY})
    DOWNLOAD_EXTRACT_TAR(
      ${DOWNLOAD_DIR}/lib
      ${DOWNLOAD_URL_PREFIX}/lib/${LIBRARY}.tar.gz
      ${DOWNLOAD_DIR}/lib
      "SKIP"
      ${LIBRARY}
      )
  ENDIF(NOT EXISTS ${DOWNLOAD_DIR}/lib/${LIBRARY})
